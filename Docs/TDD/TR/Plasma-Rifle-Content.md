...
- 2026-09-25 kullanıcı oynanış kabulü tamamlandı: kullanıcı fiziksel mermilerin, delmenin, yanma efektinin ve seviyelerin çalıştığını doğruladı. Bu mekanik kabulüdür; nihai denge veya nihai görsel onayı değildir. Aşağıdaki otomatik checkpoint bu kabulden önce kaydedilmiştir.
