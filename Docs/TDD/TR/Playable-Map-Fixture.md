...
## Windows paket sonucu — kabul engeli var
...
- Sıradaki iş: geçici kopyada import/tip verisi önbelleklerini ve URP asset'lerini ayırarak incelemek; gerekirse bağımsız import edilmiş kopya veya ayrıca kararlaştırılmış Unity sürümüyle karşılaştırmak. Kaynak projeyi kendiliğinden yükseltme veya yalnızca Editor testlerine dayanarak branch'i merge etme. Ardından `--validate-map`, görüntülü rota kabulü ve kalan harita-run entegrasyonu tamamlanmalı.
