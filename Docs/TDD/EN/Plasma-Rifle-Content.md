...
- Gameplay acceptance remains pending. In a fresh ContentArena run, acquire Plasma Rifle through F1 if not already owned, switch with Q, compare L1/L4/L7 against lined-up enemies, then L8 burn on surviving targets. Values and temporary visuals remain open to playtest adjustment.
