...
Run both suites through Unity's Test Runner window. The last recorded chest-foundation validation at Plastic changeset **cs:138** passed **522 EditMode** and **235 PlayMode** tests. These are recorded results, not a live CI badge.
